...
function renderWeek(week, input, date, onSelect) {
...
function renderBody(month, input, date, onSelect) {
  const tbody = document.createElement('tbody')
  month.forEach((week) => {
    tbody.appendChild(renderWeek(week, input, date, onSelect))
  })
...
function render({ date = currenDate, input, weekend, onSelect }) {
  ...
  calendar.appendChild(renderBody(month, input, date, onSelect))
